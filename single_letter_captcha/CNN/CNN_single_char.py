...
dir_easy = dev.MY_PROJECT_PATH+'\\DATABASES\\EasyLetter\\'
path = dir_easy+'50000_single_letter.p'
...
history = model.fit(X_train, y_train, validation_split=0.1, batch_size=1000, epochs=100, verbose=1);

print(model.evaluate(X_test, y_test))
model.save('single_char_CNN_easy.h5');
