...
for layer in model.layers[0:19]: ## with VGG, we need to keep some of the layers trinable
...
history = model_final.fit(X_train, y_train, validation_split=0.2, batch_size=300, epochs=50, verbose=1);
print(model_final.evaluate(X_test, y_test))
model_final.save('single_char_VGG_transferred_CNN.h5');
